...
def go(args):
    ...
    trainval_wandb_path = os.path.join(os.environ["WANDB_PROJECT"], args.trainval_artifact)
    logger.info(f"downloading the input artifact {trainval_wandb_path}")
    trainval_local_path = run.use_artifact(trainval_wandb_path).file()
    ######################################
